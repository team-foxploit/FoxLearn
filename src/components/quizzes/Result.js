...
class Result extends Component {
  ...
  handleSubmit = e => {
    e.preventDefault();
    const status =
      Object.keys(this.state.q1ans).length &&
      Object.keys(this.state.q2ans).length &&
      Object.keys(this.state.q3ans).length &&
      Object.keys(this.state.q4ans).length &&
      Object.keys(this.state.q5ans).length;
    console.log(status);
    if (status === 1) {
      // check answers
